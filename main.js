...
const products = [
  ...
  // Тестовый товар
  {id:0,name:"Тестовое объявление",price:10,image:"https://i.imgur.com/2yAFzGq.png",category:"Главная",description:["Тестовый товар для проверки оплаты."]}
];
...
function updateUIVisibility(){if(inCartScreen){searchInput.style.display="none"; footerButtons.style.display="none";} else{searchInput.style.display="block"; footerButtons.style.display="flex";}}
updateUIVisibility();
