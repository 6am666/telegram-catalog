...
const products = [
  ...
  {id:9,name:"Тестовый товар",price:1,image:"https://i.pinimg.com/736x/aa/aa/aa/aaaaaa.jpg",category:"Тест",description:["Это тестовый товар за 1₽","Для проверки корзины."]}
];
