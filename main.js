...
// ================== ТОВАРЫ ==================
const products = [
  {id:1,name:"Тестовый товар",price:1,image:"https://i.pinimg.com/736x/d4/c5/4c/d4c54cd9c489d1e73d9e306545929b70.jpg",category:"Тест",description:["Тестовый товар для проверки"]},
  {id:2,name:"Кольчужный топ",price:18000,image:"https://i.pinimg.com/736x/a9/95/24/a995240ff0d58266a65e1edc78c366ed.jpg",category:"Тест",description:["Материал изделия: Полностью хирургическая сталь.","","Срок изготовления — до 14 рабочих дней."]}
];
...
orderForm.onsubmit = async (e) => {
  ...
  try {
    ...
    setTimeout(()=>{
      ...
      alert("Спасибо за то что выбираете Chronicle Chains! Ваш заказ успешно оплачен. Мы уже его получили и начинаем собирать...");
    }, 2000);
